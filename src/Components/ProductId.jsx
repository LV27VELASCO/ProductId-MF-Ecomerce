...
const ProductId = () => {
  ...
  const getProductId = () => {
    axios
      .get(`https://e-commerce-api-v2.academlo.tech/api/v1/products/${id?id:1}`)
      .then((res) => {
        if (res.status == 200) {
          setProduct(res.data);
    ...
    <div className="flex flex-col items-center gap-4 flex-wrap relative">
      ...
      <section className="content">
        <article className="gallery">
          <div className="gallery__image-container" style={{ backgroundImage: `url(${imgBarckground})` }}>
          {/* Fondo de imagen */}
            </div>
          <div className="gallery__thumnails">
            ...
            ></i>
            <i onClick={() => mobilePortada("next")} className="fa-solid fa-chevron-right gallery__next hover:bg-blue-beauty hover:text-white transition-colors duration-300"></i>
            <img
              id="1"
        ...
        <article className="details">
          ...
          <div className="details__product-quantity">
            <div className="input">
              <i className="fa-solid fa-minus input__minus"></i>
              <input className="input__number" type="text" value="0" readOnly />
              <i className="fa-solid fa-plus input__plus"></i>
            </div>
